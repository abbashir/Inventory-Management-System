    ...
    <div class="col-md-4 offset-md-4 col-xs-10 offset-xs-1  box-shadow-2 p-0">
        <div class="card border-grey border-lighten-3 m-0">
            <div class="card-header no-border">
                ...
                <h6 class="card-subtitle line-on-side text-muted text-xs-center font-small-3 pt-2"><span>Login with form</span></h6>
            </div>
                ...
                <div class="card-block">
                   <form method="POST" action="{{ route('login') }}" aria-label="{{ __('Login') }}">
                        ...
                        <fieldset class="form-group position-relative has-icon-left mb-0">
                            ...
                            <input type="email" class="form-control form-control-lg input-lg {{ $errors->has('email') ? ' is-invalid' : '' }}" id="user-name" placeholder="Your email" name="email" value="{{ old('email') }}" required autofocus>
                        ...
                        <fieldset class="form-group position-relative has-icon-left">
                           ...
                           <!--  <input type="password" class="form-control form-control-lg input-lg {{ $errors->has('password') ? ' is-invalid' : '' }}" id="user-password" placeholder="Enter Password" name="" required> -->

                              <input id="password"  type="password" class="form-control form-control-lg input-lg {{ $errors->has('password') ? ' is-invalid' : '' }}" name="password" placeholder="Enter Password" required>
